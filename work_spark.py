...
with SparkDataFrame("FinancialApp") as spark_df:
    ...
    with PathFiles(6) as paths:
        ...
        stock_graphic.create_boxplot(pandas_single_1_y_df, paths[0])
        stock_graphic.create_plot(pandas_x_df, pandas_single_1_y_df, paths[1])
        ...
        stock_graphic.create_histogram(pandas_single_1_y_df, paths[4])
        stock_graphic.create_scatter(pandas_single_1_y_df, pandas_single_2_y_df, paths[5])
        other_data = stock_graphic.get_statistics(pandas_single_1_y_df)
